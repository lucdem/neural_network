from PyQt5.QtWidgets import QStackedLayout, QWidget, QVBoxLayout, QHBoxLayout, QSizePolicy
...
class NetStackedLayout(QStackedLayout):
	def __init__(self, net_manager: NetManager) -> None:
		...
		self.addWidget(ContextWidget(net_manager))
	...
	def switch_context(self):
		...
		if index is None:
			index = self.addWidget(ContextWidget(self.net_manager))
